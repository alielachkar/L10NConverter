 ...
 *
 */
public class AddEmptyLine extends SwingWorker<Boolean, Integer> {
	...
	public AddEmptyLine(Model m, List<String> fileList) {
	...
	protected Boolean doInBackground() throws Exception {
		...
		for (String activeFile : filesString) {
			...
			if (fileToConvert.exists()) {
				...
				JSUtilities.addEmptyLine(this.tempDir, fileToConvert);
