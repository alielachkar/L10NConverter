...
/**
 * Swing Worker for executing the conversion of the documents
 * 
 * @author ploh
 * @author maxc
 *
 */
public class RemoveBOM extends SwingWorker<Boolean, Integer> {
	...
	public RemoveBOM(Model m, List<String> fileList) {
	...
	protected Boolean doInBackground() throws Exception {
		...
		for (String activeFile : filesString) {
			...
			if (fileToConvert.exists()) {
				...
				JSUtilities.removeBOM(this.tempDir, fileToConvert);
