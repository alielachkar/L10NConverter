...
/**
 * Swing Worker for executing the conversion UTF8 and Remove BOM character of the documents
 * 
 * @author ploh
 * 
 *
 */
public class FileConverter extends SwingWorker<Boolean, Integer> {
	...
	public FileConverter(Model m, List<String> fileList) {
	...
	protected Boolean doInBackground() throws Exception {
		...
		for (String activeFile : filesString) {
			...
			if (fileToConvert.exists()) {
				...
				JSUtilities.convertFile(this.tempDir, fileToConvert);
